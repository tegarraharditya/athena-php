...
Feature: Homepage
  ...
  @parallel-scenario
  Scenario: TC_OW_001_003 - verify link category of Mobil Bekas
  ...
  @parallel-scenario
  Scenario: TC_OW_001_004 - verify link category of Aksesoris Mobil
    Given I am in homepage
    When I click Mobil category
  ...
  @parallel-scenario
   Scenario: TC_OW_001_005 - verify link category of Audio Mobil
     Given I am in homepage
     When I click Mobil category
  ...
  @parallel-scenario
  Scenario: TC_OW_001_006 - verify link category of Sparepart Mobil
    Given I am in homepage
    When I click Mobil category
  ...
  @parallel-scenario
  Scenario: TC_OW_001_007 - verify link category of Velg and Ban Mobil
    Given I am in homepage
    When I click Mobil category
